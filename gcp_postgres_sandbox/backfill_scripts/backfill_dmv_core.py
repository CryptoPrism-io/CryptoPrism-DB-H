# ============================================
# CryptoPrism-DB-H: DMV Core Aggregation (Hourly)
# ============================================
# Description: Aggregates all signals (OSC, MOM, RAT, TVV) into DMV_ALL table
# Input Tables: FE_OSCILLATORS_SIGNALS, FE_MOMENTUM_SIGNALS, FE_RATIOS_SIGNALS, FE_TVV_SIGNALS
# Output Tables: FE_DMV_ALL, FE_DMV_SCORES
# Frequency: Runs hourly via GitHub Actions (MUST run after all other analysis scripts)
...
# ============================================
# Data Loading: Signal Tables
# ============================================
logger.info("📊 Loading signal tables for aggregation...")
